    ...
    try {
      if (
        ...
        if (isEdit === undefined) {
          ...
          await axios.put("/api/editProduct", formData, user);
          //alert de exito
          swal(
            "Exito!",
    ...
    <div>
      <div className="create__formContainer">
        <form onSubmit={handleSubmit} className="create__formBody">
          ...
          <div className="row">
            <div className="btn btn-warning col" onClick={handleFileClick}>
          ...
          <button type="submit" className="create__button btn btn-primary">
            {isEdit === undefined ? "Crear Producto" : "Actualizar Producto"}
          </button>
        </form>
      </div>
    </div>
